                ...
                >
                  ...
                  <div className="p-2">
                    <Link href="/dashboard/profile">
                      <button className="w-full flex items-center gap-3 px-4 py-2.5 text-sm rounded-lg hover:bg-white/5 text-gray-300 hover:text-white transition-all font-medium group">
